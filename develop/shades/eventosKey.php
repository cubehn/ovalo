...
//BODY
/*
click    mouseover    mouseout    doubleclick    mouseup    mousedown
*/
//$encabezado->event->mousedown(blackbox::process2('process4'),BODY);
//$encabezado->event->mouseup(blackbox::process2('process5'),BODY);
//$encabezado->event->noVisible(blackbox::process2('process6'));
//$encabezado->event->Visible(blackbox::process2('process7'));
//este eveno es cuando el ancho del navegador cambia
//$encabezado->event->wider(blackbox::process2('process6'),1000);
//$encabezado->event->narrower(blackbox::process2('process7'),1000);
...
//$encabezado->event->narrower(blackbox::showSection($encabezado),1000);

//LO QUE SIGUE ES HACER FUNCIONAR LAS CAPSULAS, EJECUCION PASO A PASO
...
$shade->event->keydown(blackbox::process2('process4'),'n');
$shade->event->keydown(blackbox::process2('process5'),'m');
