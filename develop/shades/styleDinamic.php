...
$act1->event->click(blackbox::process2('process4'));
...
$sec1->properties->subtitle='Es posible modificar el tamaño, el estilo, el tipo de fuente y todos los demás atributos del texto, además el color del fondo, estructura de tablas, listas, en fin el estilo de todos los elementos que componen la página.
...
$sec1->style->shadow_title(4);
$sec1->embed()->script(resources::getImage('f1.jpg',300));
